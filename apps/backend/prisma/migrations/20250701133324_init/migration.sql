...
-- CreateEnum
CREATE TYPE "CoffeeSize" AS ENUM ('SMALL', 'MEDIUM', 'LARGE');

-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('CREDIT_CARD', 'DEBIT_CARD', 'ALIPAY', 'WECHAT_PAY');
...
CREATE TABLE "OrderItem" (
    ...
    "price" DECIMAL(10,2) NOT NULL,
    "size" "CoffeeSize" NOT NULL DEFAULT 'MEDIUM',
    "notes" TEXT,
...
-- CreateIndex
CREATE INDEX "Coffee_categoryId_idx" ON "Coffee"("categoryId");

-- CreateIndex
CREATE INDEX "Coffee_available_idx" ON "Coffee"("available");
...
-- CreateIndex
CREATE INDEX "Review_coffeeId_idx" ON "Review"("coffeeId");
...
-- AddForeignKey
ALTER TABLE "Review" ADD CONSTRAINT "Review_coffeeId_fkey" FOREIGN KEY ("coffeeId") REFERENCES "Coffee"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
